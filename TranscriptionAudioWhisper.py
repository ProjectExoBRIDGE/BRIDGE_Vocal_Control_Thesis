...
# The words are recognized with Whisper
...
try:  # Try to listen to the file - 0
    ...
    text = r.recognize_whisper(audio, language='it')  # saving the transcription in 'text'
...
file_excel = xlsxwriter.Workbook('Matrix_Whisper.xlsx')
...
with open('timesWhisper', 'wb') as file:           # Open the file in binary mode
    pickle.dump(process_time, file)             # Serialize and write the variable to the file

print("The data", 'timesWhisper', " has been saved successfully.")
